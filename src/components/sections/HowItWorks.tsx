...
const STEPS = [
  {
    number: "01",
    character: "/images/turma-da-monica/pose-2.png", // Mônica sentada, pensativa
  ...
  {
    number: "02",
    character: "/images/turma-da-monica/pose-12.png", // Cebolinha desenhando
  ...
  {
    number: "03",
    character: "/images/turma-da-monica/pose-6.png", // Turma correndo feliz
                ...
                <FadeIn key={i} delay={i * 0.12}>
                  <div className="flex gap-5 items-start">
                    ...
                    <div className="flex flex-col items-center shrink-0">
                      <div
                        className="w-16 h-16 rounded-2xl flex items-center justify-center shadow-lg p-2"
