      ...
      <div className="max-w-[1200px] mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {TESTIMONIALS.map((t, i) => (
            <div key={i} className="bg-white rounded-2xl p-7 border border-wire-200 flex flex-col h-full transition-all duration-300 hover:-translate-y-1 hover:shadow-md">
