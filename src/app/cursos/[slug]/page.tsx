          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.3fr] gap-8 lg:gap-16 items-start">
            ...
            <div className="flex flex-col gap-3">
              {course.modules.map((mod, i) => (
                <div key={mod.title} className="bg-white rounded-2xl border border-wire-200 p-5 sm:p-6 flex gap-4 items-start">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            {otherCourses.map((c) => (
              <a
                key={c.slug}
                href={`/cursos/${c.slug}`}
                className="group bg-white rounded-2xl border border-wire-200 overflow-hidden hover:shadow-md transition-all"
              >
